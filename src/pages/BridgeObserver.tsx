...
export const BridgeObserver: React.FC = () => {
  return (
    <div className="min-h-screen bg-charcoal font-sans text-neutral-100 antialiased">
      <SEO
        title="Bridge Observer — Market Intelligence"
        description="Institutional-style insights wire for General Exchange: curated articles, categories, and trending signals for tokenized compute workflows."
