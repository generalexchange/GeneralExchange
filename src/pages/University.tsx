...
export const University: React.FC = () => {
  return (
    <PlatformPageShell>
      <SEO
        title="University — General Exchange"
        description="Structured lessons on options, risk, and the General Exchange workflow—from fundamentals to advanced desk practice."
        keywords="trading education, options training, General Exchange university"
        canonical="https://generalexchange.com/university"
      />
