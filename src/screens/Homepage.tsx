...
function PillarCardTile({
  ...
  return (
    ...
    >
      ...
      />
      <h3
        className={`font-display text-lg sm:text-xl tracking-tight mb-1 ${isLight ? '' : 'text-neutral-50'}`}
      ...
      <p
        className={`text-sm leading-relaxed flex-1 font-light mt-2 ${isLight ? '' : 'text-neutral-400'}`}
  ...
  return (
    ...
    >
      <div className="max-w-content mx-auto px-4 sm:px-6 lg:px-10 py-14 sm:py-16 lg:py-20">
        <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_minmax(260px,380px)] xl:grid-cols-[1fr_400px] gap-10 lg:gap-12 xl:gap-14 items-start">
          <div className="min-w-0">
            ...
            <div
              className={`grid grid-cols-1 sm:grid-cols-2 ${pillar.cards.length >= 5 ? 'xl:grid-cols-3' : 'lg:grid-cols-2'} gap-4 sm:gap-5 lg:gap-6`}
            >
          ...
          <aside className="hidden lg:block lg:sticky lg:top-[calc(3.75rem+1.25rem)] self-start w-full">
            <IllustrationFrame
              theme={pillar.theme}
              title={`How ${pillar.title} works on the platform`}
              caption={pillar.mechanicsCaption}
      ...
      <div className="pt-14 sm:pt-[3.75rem]">
        ...
        >
          <div className="max-w-content mx-auto px-4 sm:px-6 lg:px-10">
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_minmax(280px,1fr)] gap-8 lg:gap-12 items-center">
              <div className="text-center sm:text-left">
                <p className="font-display text-lg sm:text-xl md:text-2xl font-medium leading-snug tracking-tight">
                  {HOMEPAGE_TAGLINE}
                </p>
                ...
                <p className="mt-4 text-xs font-semibold tracking-[0.14em] uppercase" style={{ color: BAND.text60 }}>
        ...
        >
          <div className="max-w-content mx-auto px-4 sm:px-6 lg:px-10 py-14 sm:py-20">
            ...
            <div
              className="mb-8 rounded-sm border overflow-x-auto p-4 sm:p-5"
              style={{ borderColor: BAND.border, backgroundColor: BAND.plaque }}
            >
              <ExecutionLoopIllustration />
            </div>
        ...
        <section className="bg-dark-gray border-b border-white/[0.06] py-12 sm:py-16">
          <div className="max-w-content mx-auto px-4 sm:px-6 lg:px-10 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8">
            <div className="flex flex-col sm:flex-row sm:items-center gap-6 min-w-0">
              ...
              <div>
                ...
                <p className="text-xs text-neutral-500 mt-3 font-mono">NLP → event bus → shared risk / SOR adapters</p>
              </div>
            </div>
          ...
          <div className="max-w-content mx-auto px-4 sm:px-6 lg:px-10 py-16 sm:py-20">
            ...
            >
              <div className="w-full lg:max-w-[320px] shrink-0">
                <p className="text-[10px] font-semibold tracking-[0.14em] uppercase mb-3" style={{ color: BAND.text60 }}>
                  Lineage &amp; duties
                </p>
                <TrustLineageIllustration />
              </div>
