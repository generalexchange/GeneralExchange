...
export const bridgeObserverInsights: NewsArticle[] = [
  {
    ...
    summary:
      'How allocators are mapping AMD-backed GPU hours to deterministic risk runs, and why settlement rails matter as much as FLOPs.',
  ...
  {
    id: 'bo-4',
    title: 'Inference economics: batching, SLOs, and tokenized AMD capacity',
    summary:
...
export const trendingSignals: { label: string; detail: string; tone: 'up' | 'down' | 'neutral' }[] = [
  { label: 'HBM capacity', detail: 'LUB-MI325X pool utilization 78%', tone: 'neutral' },
